      ...
      <section className="py-6 md:py-8 px-4 relative z-10">
        <div className="section-container">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <FAQItem value="faq-4" question="Quando e onde será o curso?" answer="O curso será realizado no dia 09/05 (Sábado), com duas turmas: Manhã (09h às 13h) e Tarde (14h às 18h), presencial na Rua Mateus Leme, 531 - atrás do Shopping Müller - Curitiba. As informações detalhadas do local exato serão enviadas imediatamente após sua inscrição, por WhatsApp e email." />
      ...
      <footer className="py-12 px-4 border-t border-border relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="space-y-2 text-muted-foreground">
            ...
            <p className="flex items-center justify-center gap-2">
              📍 Rua Mateus Leme, 531 - atrás do Shopping Müller - Curitiba
            </p>
          </div>
